...
<head>
    ...
    <style>
        ...
        input[type="submit"] {
            background-color:rgb(167, 125, 40);
            color: white;
            padding: 10px;
            border: none;
            border-radius: 8px;
        ...
        input[type="submit"]:hover {
            background-color:rgb(136, 108, 33);
        }
        ...
        .result {
            ...
            border-left: 4px solidrgb(167, 140, 40);
            font-size: 18px;
            color: #333;
            border-radius: 8px;
        }
...
<body>
    ...
    <div class="calculator">
        ...
        <form method="get" action="">
            ...
            Third Number:
            <input type="number" name="num3" requird>
...
if (isset($_GET["num1"], $_GET["num2"], $_GET["operator"])) {
    ...
    switch ($op) {
        ...
        case "divide":
            ...
            break;
        case "percent":
             $step1 = ($num1 / 100) * $num2;      // num1% of num2
             $result = ($step1 / 100) * $num3;    // then % of num3
            break;
        case "exponent":
              $step1 = pow($num1, $num2);
              $result = pow($step1, $num3);
            break;
    default:
...
<head>
    ...
    <style>
        ...
        input[type="submit"],
        .clear {
            background-color:rgb(167, 129, 40);
            color: white;
            padding: 10px;
            border: none;
            border-radius: 8px;
        ...
        .result {
            ...
            border-left: 4px solidrgb(167, 123, 40);
            font-size: 18px;
            color: #333;
            border-radius: 8px;
        }
